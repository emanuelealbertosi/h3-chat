...
INCLUDE=('native','h3chat','static','licenses','docs','scripts/Launcher.cs','scripts/install.ps1','app.py','launcher.py','catalog.json','runtimes.json',
         'H3-Chat.exe','Installa-H3-Chat.bat','Avvia-H3-Chat.bat','Ferma-H3-Chat.bat','README.md','LICENSE','NOTICE','runtime/python','runtime/music/cpu')


def main():
    for required in ('runtime/python/python.exe','H3-Chat.exe','static/app.js','native/h3-sd-worker.exe','runtime/music/cpu/h3-music-worker.exe','README.md'):
    ...
    archive=out/'H3-Chat-0.9.1-windows-x64.zip'
    manifest={}
