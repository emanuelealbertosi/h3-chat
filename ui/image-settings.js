...
export function renderImagePreferences(container,draft,state,onChange){
 ...
 const preset={width:draft.width,height:draft.height,steps:model?.steps??draft.steps,cfg:model?.cfg??draft.image_cfg,
  ...
  seed:draft.seed,negative_prompt:draft.negative_prompt,strength:draft.strength};
