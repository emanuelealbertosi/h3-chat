import {renderMusicSettings,appendMusicDetails} from './music-settings.js';
...
function renderSettings(){
  ...
  body.onchange=e=>{if(e.target.matches('[data-setting]')){collectSettings();updateVision();updateMtpSettings();updateDownloads();scheduleAssessment();}};
